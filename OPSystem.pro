#-------------------------------------------------
#
# Project created by QtCreator 2019-01-11T09:49:38
#
#-------------------------------------------------
...
LIBS += -L$$PWD/glew/lib/Release/Win32/ -lglew32s
LIBS += -lopengl32
...
win32:!win32-g++: PRE_TARGETDEPS += $$PWD/'../../../../Program Files/Assimp/lib/x64/assimp.lib'
else:win32-g++: PRE_TARGETDEPS += $$PWD/'../../../../Program Files/Assimp/lib/x64/libassimp.a'
